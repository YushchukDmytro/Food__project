...
function calc() {
  ...
  var sex, height, weight, age, retio;
...
function cards() {
  ...
  var MenuCard = /*#__PURE__*/function () {
    function MenuCard(src, alt, title, descr, price, parentElement) {
...
function form(formSelector, openTimeId) {
  ...
  function bindFormData(form) {
    form.addEventListener('submit', function (e) {
      e.preventDefault();
      var statusDate = document.createElement('img');
      ...
      (0,_services_services__WEBPACK_IMPORTED_MODULE_7__.postData)('http://localhost:3000/requests', JSON.stringify(obj)).then(function (data) {
        console.log(data);
  ...
  function showThanksModal(message) {
    ...
    (0,_modal__WEBPACK_IMPORTED_MODULE_6__.openModal)('.modal', openTimeId);
    ...
    setTimeout(function () {
      ...
      (0,_modal__WEBPACK_IMPORTED_MODULE_6__.closeModal)('.modal');
    }, 4000);
  }
}
...
function closeModal(modalSelected) {
  var modal = document.querySelector(modalSelected);
...
function modal(triggerSelected, modalSelected, openTimeId) {
  //  Modal
  var modalTrigger = document.querySelectorAll(triggerSelected),
      modal = document.querySelector(modalSelected);
  modalTrigger.forEach(function (btn) {
    btn.addEventListener('click', function () {
      return openModal(modalSelected, openTimeId);
    });
  });
...
function slider(_ref) {
  ...
  function slideMove(fild, num) {
    fild.style.transform = "translateX(-".concat(num, "px)");
  }

  function currInfo(curr, index) {
    if (slides.length < 10) {
      curr.textContent = "0".concat(index);
    } else {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            throw new Error("Could not fatch ".concat(url, ", status wrong ").concat(result.status));
...
window.addEventListener('DOMContentLoaded', function () {
  var openTimeId = setTimeout(function () {
    return (0,_modules_modal__WEBPACK_IMPORTED_MODULE_3__.openModal)('.modal', openTimeId);
  }, 50000);
  (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.tabheader__item', '.tabcontent', '.tabheader__items', 'tabheader__item_active');
  (0,_modules_modal__WEBPACK_IMPORTED_MODULE_3__["default"])('[data-modal]', '.modal', openTimeId);
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_4__["default"])('.timer', '2022-08-08');
  (0,_modules_cards__WEBPACK_IMPORTED_MODULE_5__["default"])();
  (0,_modules_calc__WEBPACK_IMPORTED_MODULE_6__["default"])();
  (0,_modules_forms__WEBPACK_IMPORTED_MODULE_7__["default"])('form', openTimeId);
